 ...
 * @returns {Promise}
 */
export function getBodyIndicators(params) {
  return request({ url: '/dashboard/body-indicators', method: 'get', params })
}
 ...
 * @returns {Promise}
 */
export function getDataTop5(params) {
  return request({
    url: '/dashboard/top5',
    method: 'get',
    params
 ...
 * @returns {Promise}
 */
export function getDeviceActivation(params) {
  return request({ url: '/dashboard/device-activation', method: 'get', params })
}
 ...
 *   [ { "name": "研发部", "count": 1234 }, ... ]
 */
export function getDeptHealthCounts(params) {
  return request({ url: '/dashboard/dept-stats', method: 'get', params })
}
...
export function getDailyTrend(days) {
  return request({ url: '/dashboard/daily-trend', method: 'get', params: { days } })
}
