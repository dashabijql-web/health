...
class PreShiftReviewServiceTest {
    ...
    @Test
    void synchronizesLatestMeasurementsBeforeReturningSummary() {
        ...
        verify(mapper).getTodayCandidates();
    }
    ...
    void insertsPendingReviewForNewAbnormalMeasurement() {
        ...
        when(mapper.getTodaySummary()).thenReturn(new PreShiftReviewSummaryRow());
