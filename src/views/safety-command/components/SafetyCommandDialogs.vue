...
const props = defineProps({
  ...
  currentArea: { type: Object, default: null },
  currentDept: { type: Object, default: null },
...
const emit = defineEmits([
  'update:eventDialogVisible',
  'update:areaDialogVisible',
  'update:deptDialogVisible',
  'update:broadcastDialogVisible',
  'update:contactDialogVisible',
  'update:infoDialogVisible',
  'update:broadcastContent',
  'handleEvent',
  'showPersonFromEvent',
  'showInfo',
  'deptDialogOpen',
...
const getLevelText = (level) => ({ critical: '特急', high: '紧急', medium: '一般', low: '轻微' }[level] || level)
</script>
