...
defineProps({
  stats: { type: Object, default: () => ({underground:0,total:0,sos:0,fall:0,static:0,abnormal:0,normal:0}) },
  watchStatus: { type: Object, default: () => ({total:0,online:0,offline:0,lowBattery:0,onlineRate:0}) },
