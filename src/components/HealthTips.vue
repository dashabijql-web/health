...
const ALL_TIPS = [
  ...
  { id: 2,  emoji: '🚶', text: '久坐超过 1 小时请起身活动 3–5 分钟，做肩颈后仰伸展，缓解肌肉紧张。' },
  { id: 3,  emoji: '❤️', text: '心率偏快时先放慢呼吸，避免咖啡因与情绪波动；持续异常请及时就医评估。' },
  { id: 4,  emoji: '🩸', text: '高血压家族史人群建议每周自测 2–3 次血压，同一时间段、坐位静息测量。' },
  { id: 6,  emoji: '🍎', text: '每天 300–500g 蔬果，至少 3 种颜色，优先整果整蔬，减少果汁和糖分摄入。' },
  { id: 7,  emoji: '🧂', text: '成人每日食盐不超过 5g；外卖重口味选少盐少酱料，养成看营养成分表的习惯。' },
  { id: 8,  emoji: '🧠', text: '压力大时试试 4-7-8 呼吸法：吸气4秒、屏气7秒、呼气8秒，循环 4 次。' },
  { id: 9,  emoji: '🧘', text: '午后疲劳时做 2 分钟闭眼冥想或身体扫描，有助于恢复专注与情绪稳定。' },
  { id: 10, emoji: '👀', text: '用眼遵循 20-20-20 法则：每 20 分钟，看 20 英尺外 20 秒，减轻眼部疲劳。' },
  { id: 11, emoji: '🏃', text: '每周至少 150 分钟中等强度运动；走路、骑行与爬楼都是高性价比选择。' },
  { id: 12, emoji: '🧯', text: '在高温或粉尘环境工作注意补水与防护，必要时佩戴口罩与护目镜。' },
  { id: 13, emoji: '🥗', text: '餐盘法：蔬菜占一半，蛋白质和主食各占四分之一，减少油炸高脂肪食物。' },
  { id: 14, emoji: '🫀', text: '吸烟伤心血管与肺部，尽量减少二手烟暴露；需要时寻求专业戒烟帮助。' },
  { id: 15, emoji: '🦷', text: '每天认真刷牙两次各 2–3 分钟，使用牙线清理齿缝，半年到一年洗牙一次。' },
  { id: 16, emoji: '🌡️', text: '体温持续超过 37.5°C 超过两天，或伴随其他症状，请及时就医检查。' },
  { id: 17, emoji: '🩺', text: '收缩压超过 140 或舒张压超过 90 为高血压，需在医生指导下调整生活方式或用药。' },
  { id: 18, emoji: '🥤', text: '含糖饮料每周不超过 1–2 次；优先白水、无糖茶或淡咖啡，避免能量饮料。' },
